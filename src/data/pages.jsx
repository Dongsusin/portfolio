  ...
  },
  {
    ...
    content: (
      <div className="project-page">
        ...
        />
        <div className="project-item skill glow-text">
          <h3>영화웹 프로젝트</h3>
    ...
    content: (
      <div className="project-page glow-text">
        <div className="project-item ">
          ...
          <h3>&bull;메인페이지</h3>
          <p>
            영화 예고편을 랜덤으로 5개불러와서 티저느낌으로 랜더링하며 밑에는
            영화리스트를 구현
          </p>
          ...
          <h3>&bull;상세페이지</h3>
          <p>
            영화 이미지를 클릭해서 상세페이지로 이동이 가능하며 상세페이지에서는
            해당영화의 다양한정보와 예고편을 볼수있습니다.
          </p>
          <h3>&bull;예메페이지</h3>
          <p>
            예메하기 버튼을 클릭해서 이동할수있으며, 실제 영화를 예메하는
            느낌이나도록 구현했습니다.
          </p>
          <h3>&bull;상점페이지/장바구니</h3>
          <p>
            상점페이지에서 상품을 장바구니에 추가할수있으며 추가된 상품은 해더에
            장바구니/수량으로 표시돼며 장바구니클릭으로 현재추가한 상품을
            볼수있습니다.
          </p>
          <h3>&bull;티켓페이지</h3>
          <p>
      ...
      <div className="project-page glow-text">
        <div className="project-item">
          ...
          <p>
            ...
            포켓몬을 필터링, 세대별 필터링은 각 세대에따라 번호범위를 주고 해당
            범위의 포켓몬을 필터링, 즐겨찾기는 즐겨찾기를 추가한 포켓몬만 필터링
          </p>
          <h3>&bull;페이지 네이션</h3>
    ...
    content: (
      <div className="project-page glow-text">
        <div className="project-item">
          ...
          <p>
            위도/경도 정보를 기반으로 여행지를 지구본 위에 마커로 표시하며, 위치
            계산을 통해 3D 좌표에 정확히 배치
          </p>

          <h3>&bull;마커 Hover & Click 인터랙션</h3>
          <p>
            마커에 마우스를 올리면 여행지 이름을 툴팁으로 보여주고, 클릭 시 해당
            여행지의 상세 정보 창으로 이동
          </p>
    ...
    content: (
      <div className="project-page">
        ...
        <div className="project-item skill glow-text">
          <h3>PC프로젝트</h3>
          <div className="project-title">
            <a href="https://jovial-alpaca-3d63f1.netlify.app/">배포 사이트</a>
      ...
      <div className="project-page glow-text">
        <div className="project-item">
          ...
          <p>
            ...
            구성하며, 하단에는 작업 표시줄(하단바)과 현재 날짜를 확인할 수 있는
            달력 위젯을 구현
          </p>
          ...
          <h3>&bull;날씨 앱</h3>
          <p>OpenWeatherApi를 이용해서 현재위치에대한 날씨정보를 보여줍니다.</p>
    ...
    content: (
      <div className="project-page glow-text">
        <div className="project-item">
          ...
          <h3>&bull;타임어택모드</h3>
          <p>
            일정시간동안 기록을 내는 모드로 상단에 프로그래스바 형식으로 타이머
            표시
          </p>
