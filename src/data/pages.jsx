...
const pages = (goToPage, isMobile, book, setCurrentIndex, setSlideDirection) => [
  {
    title: "",
    content: (
    ...
    content: (
      <div className="intro-page">
        ...
        <div className="info-text glow-text">
          <p><strong>이름:</strong> 신동수</p>
          <p><strong>나이:</strong> 24 (2002)</p>
          <p><strong>성별:</strong> 남</p>
          <p><strong>전화번호:</strong> 010-2201-5617</p>
          <p><strong>이메일:</strong> auroratime020715@gmail.com</p>
          <a href="/이력서/이력서.pdf" download className="resume-button">이력서 다운로드</a>
        </div>
      </div>
    ),
  },
